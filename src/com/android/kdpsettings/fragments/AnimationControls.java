...
public class AnimationControls extends PreferenceFragment implements OnPreferenceChangeListener {
	 ...
	 * number.
	 */
	public static AnimationControls newInstance(int sectionNumber) {
		AnimationControls fragment = new AnimationControls();
