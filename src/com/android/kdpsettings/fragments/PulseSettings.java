...
public class PulseSettings extends PreferenceFragment implements
	 ...
	 * number.
	 */
	public static PulseSettings newInstance(int sectionNumber) {
		PulseSettings fragment = new PulseSettings();
	...
	PreferenceScreen prefs = getPreferenceScreen();
        ...
        mShowPulse.setChecked(Settings.Secure.getInt(resolver,
        ...
        mLavaLampEnabled.setChecked(Settings.Secure.getInt(resolver,
                Settings.Secure.FLING_PULSE_LAVALAMP_ENABLED, 1) == 1);
        mLavaLampEnabled.setOnPreferenceChangeListener(this);

        mCustomDimen =
                    (KangDroidSeekBarPreference) findPreference(CUSTOM_DIMEN);
        ...
        int speed = Settings.Secure.getInt(resolver,
        ...
        int fspeed = Settings.Secure.getInt(resolver,
