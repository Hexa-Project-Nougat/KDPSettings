...
public class PieControl extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
	 ...
	 * number.
	 */
	public static PieControl newInstance(int sectionNumber) {
		PieControl fragment = new PieControl();
