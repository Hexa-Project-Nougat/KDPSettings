...
public class KangDroidQuickSettings extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
	 ...
	 * number.
	 */
	public static KangDroidQuickSettings newInstance(int sectionNumber) {
		KangDroidQuickSettings fragment = new KangDroidQuickSettings();
