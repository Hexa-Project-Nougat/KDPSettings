...
public class PieColor extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
	 ...
	 * number.
	 */
	public static PieColor newInstance(int sectionNumber) {
		PieColor fragment = new PieColor();
