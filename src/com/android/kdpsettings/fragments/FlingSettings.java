...
import com.android.kdpsettings.utils.*;
...
public class FlingSettings extends ActionFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShowLogo.setChecked(Settings.Secure.getInt(resolver,
        ...
        mAnimateLogo.setChecked(Settings.Secure.getInt(resolver,
                Settings.Secure.FLING_LOGO_ANIMATES, 1) == 1);
        mAnimateLogo.setOnPreferenceChangeListener(this);

        int logoColor = Settings.Secure.getIntForUser(resolver,
        ...
        mShowRipple.setChecked(Settings.Secure.getInt(resolver,
        ...
        mTrailsEnabled.setChecked(Settings.Secure.getInt(resolver,
